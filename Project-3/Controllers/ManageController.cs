...
namespace Project_3.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangePersonalInfo(ManageMessageId? message)
        {
        ...
        public ActionResult ChangePersonalInfo(UserProfileViewModel modal, HttpPostedFileBase Avatar)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("ChangePersonalInfo", "Manage", new { Message = ManageMessageId.ChangeInfoSuccess });
            }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return RedirectToAction("ChangePersonalInfo", "Manage", new { Message = ManageMessageId.IncorrectPassword });
            }
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("ChangePersonalInfo", "Manage",new { Message = ManageMessageId.ChangePasswordSuccess });
            }
            AddErrors(result);
            return View(model);
        }
